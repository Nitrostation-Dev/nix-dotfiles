{ pkgs, ... }:
{
    ...
    dconf.settings = {
        ...
        "org/gnome/shell/extensions/dash2dock-lite" = {
            ...
            border-thickness = 1;
            border-color = [0.77254903316497803 0.80784314870834351 0.92156863212585449 0.19666667282581329];
            background-color = [0.11764705926179886 0.11764705926179886 0.18039216101169586 0.73000001907348633];
